...
const ytmp3 = async (url) => new Promise((resolve, reject) => {
    axios.get(`https://docs-jojo.herokuapp.com/api/yt-play?q=${url}`)
    .then((res) => {
		resolve(res.data)
    })
    .catch((err) =>{
